...
import { getWeeklyAnalysis } from "../services/api";
...
const WeeklyAnalysis: React.FC<WeeklyAnalysisProps> = ({ refreshTrigger = 0 }) => {
  ...
  useEffect(() => {
    fetchAnalysis();
    // If debounce is needed for user-triggered refresh, re-enable above
  ...
  const getMoodColor = (mood: string) => {
    const colors: { [key: string]: string } = {
      glad: '#4caf50', lycklig: '#8bc34a', nöjd: '#cddc39', tacksam: '#ffeb3b', positiv: '#ffc107',
      ledsen: '#ff9800', arg: '#f44336', stressad: '#e91e63', deppig: '#9c27b0', frustrerad: '#673ab7',
      irriterad: '#3f51b5', orolig: '#2196f3'
    };
