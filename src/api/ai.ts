...
export const transcribeAudio = async (
  ...
  try {
    ...
    console.warn('Audio transcription not available, using fallback');
...
export const analyzeVoiceEmotion = async (
  ...
  try {
    ...
    // Fallback for unimplemented endpoint
    console.warn('Voice emotion analysis not available, using fallback');
...
export const analyzeTextSentiment = async (
  ...
  try {
    ...
    // Fallback
    console.warn('Text analysis not available, using fallback');
