...
>(({ className, children, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn('text-2xl font-bold tracking-tight text-calm-800', className)}
    {...props}
  >
    {children}
  </h3>
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-sm text-calm-600 dark:text-gray-400', className)}
    {...props}
  />
));
...
// MUI Paper compatibility - Paper is just a Card variant
