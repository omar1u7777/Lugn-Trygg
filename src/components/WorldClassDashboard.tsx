  ...
  return (
    <div className="world-class-dashboard relative" aria-busy={loading}>
      ...
      <div className="world-class-dashboard-content px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* HERO-SEKTION: Main decision point */}
        <Card className="mb-8 border-l-4 border-l-secondary-500 bg-gradient-to-br from-secondary-50 to-primary-50 dark:from-secondary-900/20 dark:to-primary-900/20">
          <div className="p-6 sm:p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg">
                Välj vad som känns rätt för dig idag
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <Button
                ...
                variant="primary"
                className="flex-1 min-h-[48px] text-lg font-semibold"
                aria-label="Logga ditt humör"
              >
                📝 Logga Humör
              </Button>
              <Button
        ...
        {/* TRYGGHETSSTATUS: Safety status with interpreted trends */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 bg-secondary-50 dark:bg-secondary-900/20 rounded-lg">
                <div className="text-2xl mb-2">
                  {safeDashboardStats.averageMood >= 7 ? '☀️' :
                   safeDashboardStats.averageMood >= 5 ? '⛅' : '🌧️'}
                </div>
                <div className="font-semibold text-gray-900 dark:text-white">
                  {safeDashboardStats.averageMood >= 7 ? 'Stabilt positivt' :
                   safeDashboardStats.averageMood >= 5 ? 'Ganska bra' : 'Behöver uppmärksamhet'}
                </div>
              ...
              <div className="text-center p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
                ...
                <div className="font-semibold text-gray-900 dark:text-white">
                  {safeDashboardStats.streakDays > 7 ? 'Stark vana' :
                   safeDashboardStats.streakDays > 3 ? 'Bra rytm' : 'Bygg vana'}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  {safeDashboardStats.streakDays} dagars streak
                </div>
              </div>
              ...
              <div className="text-center p-4 bg-teal-50 dark:bg-teal-900/20 rounded-lg">
                <div className="text-2xl mb-2">📊</div>
                <div className="font-semibold text-gray-900 dark:text-white">
                  {safeDashboardStats.totalMoods > 10 ? 'Mycket aktiv' :
                   safeDashboardStats.totalMoods > 5 ? 'Regelbunden' : 'Komma igång'}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  {safeDashboardStats.totalMoods} loggade stunder
                </div>
              </div>
            </div>
          </div>
        ...
        {/* DITT FOKUS IDAG: Single recommendation */}
        <Card className="mb-8 border-l-4 border-l-amber-500 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20">
          <div className="p-6 sm:p-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-1">
                    Ta 5 minuter för dig själv
                  </h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    En kort mindfulness-övning kan göra stor skillnad för ditt välmående idag.
                  </p>
                  <Button
                    variant="secondary"
                    size="sm"
        ...
        {/* HISTORIK: History and motivation at bottom */}
