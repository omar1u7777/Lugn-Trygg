...
class TestListJournalEntries:
    ...
    def test_list_entries_success(self, client, auth_csrf_headers, mock_journal_db):
        resp = client.get(f"{BASE}/{USER_ID}/journal", headers=auth_csrf_headers)
    ...
    def test_list_entries_unauthorized(self, client, auth_csrf_headers, mock_journal_db):
        # Valid UID that differs from g.user_id → 403
        resp = client.get(f"{BASE}/{OTHER_USER_ID}/journal", headers=auth_csrf_headers)
...
class TestCreateJournalEntry:
    ...
    def test_create_entry_success(self, client, auth_csrf_headers, mock_journal_db):
        resp = client.post(
    ...
    def test_create_entry_missing_content(self, client, auth_csrf_headers, mock_journal_db):
        resp = client.post(
            f"{BASE}/{USER_ID}/journal",
            json={"mood": 5},
            headers=auth_csrf_headers,
    ...
    def test_create_entry_content_too_short(self, client, auth_csrf_headers, mock_journal_db):
        resp = client.post(
            f"{BASE}/{USER_ID}/journal",
            json={"content": "ab"},
            headers=auth_csrf_headers,
    ...
    def test_create_entry_invalid_mood(self, client, auth_csrf_headers, mock_journal_db):
...
class TestUpdateJournalEntry:
    ...
    def test_update_entry_success(self, client, auth_csrf_headers, mock_journal_db):
        resp = client.put(
    ...
    def test_update_entry_not_found(self, client, auth_csrf_headers, mock_db):
...
class TestDeleteJournalEntry:
    ...
    def test_delete_entry_success(self, client, auth_csrf_headers, mock_journal_db):
        resp = client.delete(
            f"{BASE}/{USER_ID}/journal/{ENTRY_ID}",
            headers=auth_csrf_headers,
        )
    ...
    def test_delete_entry_wrong_user(self, client, auth_csrf_headers, mock_journal_db):
