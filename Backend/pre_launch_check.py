...
def check_ssl_certificate():
    ...
    nginx_config = os.path.join(os.path.dirname(__file__), '..', 'nginx-production.conf')
...
def check_backups():
    ...
    backup_script = os.path.join(os.path.dirname(__file__), 'backup_firestore.py')
...
def check_security():
    ...
    secrets_backup = os.path.join(os.path.dirname(__file__), 'secrets_backup')
