...
class SwedishMoodNLP:
    ...
    def _bert_analysis(self, text: str, context: list[str] | None) -> MoodAnalysis:
    ...
    def _semantic_analysis(self, text: str, context: list[str] | None) -> MoodAnalysis:
...
# Singleton instance
_mood_nlp: SwedishMoodNLP | None = None
