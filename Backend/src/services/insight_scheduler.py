...
from src.services.daily_insight_service import get_insight_generator, TherapeuticInsight
...
class InsightNotificationScheduler:
    ...
    def trigger_immediate_insight(self, user_id: str, insight_type: str = 'checkin') -> Optional[str]:
        """
...
# Global instance
_scheduler: Optional[InsightNotificationScheduler] = None
