...
class MemoryAnalysisResult:
    ...
    narrative_connection: Optional[str]  # connection to life story
...
class MemoryAnalysisService:
    ...
    def analyze_text_memory(self, text: str, context: Optional[Dict] = None) -> MemoryAnalysisResult:
        """
    ...
    def detect_memory_patterns(self, memories: List[Dict]) -> List[MemoryPattern]:
        ...
        if recurring:
            ...
            patterns.append(MemoryPattern(
                ...
                psychological_significance=f"Detta tema verkar ha betydelse för din livsberättelse"
            ))
...
_memory_analysis_service: Optional[MemoryAnalysisService] = None
