...
try:
    ...
    from tensorflow.keras.layers import (
        ...
        Concatenate, Reshape, Permute, Multiply, Lambda
    )
...
class TemporalAttentionLSTM:
    ...
    def prepare_features(self, mood_entries: List[Dict], 
                        contextual_data: Optional[Dict] = None) -> np.ndarray:
        """
    ...
    def train(self, mood_entries: List[Dict], 
              contextual_data: Optional[List[Dict]] = None,
    ...
    def _create_sequences(self, mood_entries: List[Dict], 
                          contextual_data: Optional[List[Dict]]) -> Tuple[np.ndarray, np.ndarray]:
...
# Singleton
_lstm_model: Optional[TemporalAttentionLSTM] = None
