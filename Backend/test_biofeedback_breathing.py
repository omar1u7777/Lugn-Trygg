...
try:
    ...
    print(f'✅ HRVAnalyzer initialized')
...
try:
    ...
    print(f'✅ BiofeedbackBreathingService initialized (singleton)')
    ...
    print(f'✅ Real-time feedback generated:')
    ...
    print(f'✅ Session ended and saved to Firestore')
...
try:
    ...
    print(f'✅ WebSocket/REST routes registered:')
    for route in routes:
        print(f'   - {route}')
...
try:
    ...
    print(f'   - Range: 4-8 breaths/min (physiological optimal)')
